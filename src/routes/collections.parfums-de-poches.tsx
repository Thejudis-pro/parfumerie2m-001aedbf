...
const TITLE = "Parfums de Poches dakar | Mini parfums livrés à Dakar — 2M Parfumerie";
const DESC =
  "Achetez des parfums de poches au dakar dès 2 000 FCFA. Livraison à Dakar. Composez votre pack de 5 parfums de poches pour 10 000 FCFA chez 2M Parfumerie.";
