...
const coffretOptions: Record<CoffretCollection, CoffretOption[]> = {
  ...
  scentlab: [
    { id: "scentlab-frais", title: "Frais propre", description: "Une sensation nette, claire et très portable." },
    { id: "scentlab-gourmand", title: "Gourmand crémeux", description: "Plus doux, plus enveloppant, avec du relief." },
    { id: "scentlab-fruite", title: "Fruité lumineux", description: "Juteux, vivant, facile à aimer dès le premier spray." },
    { id: "scentlab-vanille", title: "Vanille moderne", description: "Une douceur élégante, actuelle et rassurante." },
    { id: "scentlab-boise", title: "Boisé chic", description: "Une base plus structurée, propre et raffinée." },
    { id: "scentlab-oriental", title: "Oriental velouté", description: "Plus profond, plus sensuel, plus marquant." },
  ],
};
