...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "2M Parfumerie Dakar | Parfums authentiques" },
      { property: "og:description", content: "Parfumerie de luxe à Dakar. Commandez des parfums authentiques et accessibles directement sur WhatsApp." },
